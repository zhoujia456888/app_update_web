            ...
            <UCard>
                ...
                <div class="space-y-5">
                            ...
                            <UButton
                                ...
                                :icon="
                                    _showConfirmPwd
                                        ...
                                        : 'i-lucide-eye'
                                "
                                @click="_showConfirmPwd = !_showConfirmPwd"
                            />
                        </template>
                    </UInput>
                    ...
                    <div class="flex flex-col space-y-5">
                        ...
                        <ULink
                            to="/login"
                            class="flex-1 flex items-center justify-center text-gray-400 text-center font-light text-sm"
                        >
                            < 返回登录
                        </ULink>
                    </div>
...
async function refreshCaptcha() {
	...
	try {
		...
		const errorMessage = getHttpErrorMessage(error, "获取验证码失败");
